                ...
                <li class="dropdown user user-menu">
                    <?php if (!Yii::$app->user->isGuest):?>
                        <?= Html::a(
                            ...
                            Yii::t('yii', 'Exit') . ' (' . Yii::$app->user->identity->username . ')'
                            . '</span>',
                            ['/site/logout'], [
                            'data' => [
                                'method' => 'post',
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="#" class="btn btn-default btn-flat">Пользователи</a>
                                </div>
                                <div class="pull-right">

                                    <?= Html::beginForm('/site/logout', 'post') ?>

                                    <?= Html::submitButton(Yii::t('yii', 'Sign out'), ['class' => 'btn btn-default btn-flat']) ?>
