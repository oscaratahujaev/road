...
use app\models\ref\search\RefRegionSearch;
...
class RefRegionController extends Controller
{
    ...
    /**
     * Displays a single RefRegion model.
     * @param integer $id
     * @return mixed
     */
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new RefRegion",
                    'content'=>'<span class="text-success">Create RefRegion success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing RefRegion model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing RefRegion model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
